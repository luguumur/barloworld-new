		...
		<div>
			...
			<div className='mb-11 grid grid-cols-1 gap-7.5 sm:grid-cols-2 xl:grid-cols-4'>
				{Array.from({ length: 4 }).map((_, i) => (
					<div key={i} className='rounded-10 bg-white p-6 shadow-1 dark:bg-gray-dark'>
						<div className='mb-6 h-[58px] w-[58px] animate-pulse rounded-full bg-gray-2 dark:bg-white/10' />
						<div className='h-7 w-20 animate-pulse rounded bg-gray-2 dark:bg-white/10 mb-2' />
			...
			<div className='mb-7.5'>
				<div className='h-6 w-28 animate-pulse rounded bg-gray-2 dark:bg-white/10 mb-2' />
				...
				{Array.from({ length: 3 }).map((_, i) => (
					<div key={i} className='rounded-10 bg-white p-6 shadow-1 dark:bg-gray-dark'>
						...
						{Array.from({ length: 5 }).map((_, j) => (
							<div key={j} className='flex justify-between border-b border-stroke py-3 dark:border-dark-3'>
								<div className='h-4 w-32 animate-pulse rounded bg-gray-2 dark:bg-white/10' />
