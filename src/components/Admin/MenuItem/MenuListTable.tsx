			...
			<table className='w-full'>
				<thead>
					<tr className='hidden border-b border-stroke dark:border-stroke-dark lsm:table-row'>
						<th
							className='w-10 min-w-[40px] px-2 py-5 sm:pl-4'
							aria-label='Drag'
						/>
				...
				<tbody>
					{items.map((item, index) => (
						...
						>
							<td
								className='cursor-grab p-2 pl-4 active:cursor-grabbing sm:pl-4'
							...
							<td className='p-4 text-left text-base tracking-[-.16px] text-body dark:text-gray-5'>
								{item.linkType === "PAGE" ? (
									...
									<a
										...
										target='_blank'
										rel='noopener noreferrer'
										className='block max-w-[200px] truncate text-primary hover:underline dark:text-primary'
									>
										{item.path}
									</a>
								)}
