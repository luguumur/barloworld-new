...
import { deleteProductType } from "@/actions/productType";

type Item = { id: string; name: string; name_en: string };

export default function ProductTypeAction({ item }: { item: Item }) {
	...
	return (
		<>
			<div className="mt-2 flex flex-wrap items-center gap-3.5 lsm:ml-auto lsm:justify-end sm:mt-0">
				<Link
					href={`/admin/product-types/${item.id}/edit`}
			...
			<DeleteModal
				...
				deleteText="Remove product type"
