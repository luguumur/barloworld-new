...
import { deleteProductCategory } from "@/actions/productCategory";

type Item = { id: string; name: string; name_en: string; types: string };

export default function ProductCategoryAction({ item }: { item: Item }) {
