			...
			<table className='w-full'>
				...
				<tbody>
					{translations.map((t) => (
						...
						>
							<td className='font-mono p-4 text-left text-sm tracking-tight text-body dark:text-gray-5 sm:pl-7.5'>
								{t.key}
							</td>
							<td className='max-w-[260px] p-4 text-left text-base tracking-[-.16px] text-body dark:text-gray-5'>
								...
								<span className='mt-0.5 line-clamp-2 block text-sm text-body/70 md:hidden'>
									{t.value_en}
								</span>
