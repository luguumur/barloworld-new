	...
	return (
		<div className="rounded-10 bg-white p-6 shadow-1 dark:bg-gray-dark sm:p-8">
			...
			<p className="mb-6 text-sm text-body/70 dark:text-gray-5">
				Key format: <code className="rounded bg-gray-100 px-1 py-0.5 font-mono dark:bg-white/10">Namespace.keyName</code> (e.g. <code className="rounded bg-gray-100 px-1 py-0.5 font-mono dark:bg-white/10">HomeData.title</code>) or a top-level key like <code className="rounded bg-gray-100 px-1 py-0.5 font-mono dark:bg-white/10">Menu</code>.
			</p>
			<form onSubmit={handleSubmit} className="flex flex-col space-y-4">
				...
				<div>
					...
					<textarea
						value={data.value_mn}
						onChange={(e) => setData((p) => ({ ...p, value_mn: e.target.value }))}
				...
				<div>
					...
					<textarea
						value={data.value_en}
						onChange={(e) => setData((p) => ({ ...p, value_en: e.target.value }))}
