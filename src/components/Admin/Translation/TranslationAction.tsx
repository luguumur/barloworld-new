...
import { deleteTranslation } from "@/actions/translation";
import type { TranslationRow } from "@/actions/translation";

export default function TranslationAction({ translation }: { translation: TranslationRow }) {
