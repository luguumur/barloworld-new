...
export default function ManagementTopbar({ initialSearch = "" }: { initialSearch?: string }) {
		...
		<div className="items-center justify-between rounded-10 bg-white px-3.5 py-3 shadow-1 dark:bg-gray-dark md:flex">
			...
			<div className="flex flex-wrap items-center gap-3">
				<form
					onSubmit={(e) => {
						e.preventDefault();
						router.push(`/admin/management?search=${encodeURIComponent(search)}`);
					}}
				>
