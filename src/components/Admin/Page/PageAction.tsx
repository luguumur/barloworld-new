...
export default function PageAction({ page }: { page: Page }) {
		...
		<>
			<div className="mt-2 flex flex-wrap items-center gap-3.5 lsm:ml-auto lsm:justify-end sm:mt-0">
				<Link
					...
					className="flex h-10 items-center justify-center rounded-lg border border-stroke px-3 text-body hover:bg-gray-1 dark:border-stroke-dark dark:text-gray-5 dark:hover:bg-white/5"
				>
					View
				</Link>
				<Link
