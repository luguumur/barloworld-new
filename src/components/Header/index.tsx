		...
		<>
			...
			>
				<div className='relative mx-auto max-w-[1170px] items-center justify-between gap-2 border-b border-gray-3 px-4 dark:border-dark-2 sm:px-8 xl:flex xl:border-0 xl:px-0'>
					{/* Logo + hamburger */}
					<div className='flex w-full items-center justify-between py-3 xl:w-2/12 xl:py-0'>
						<Link href='/'>
							<Image
								src={logoLight}
					...
					{/* Nav + actions */}
					<div
						className={`invisible h-0 w-full items-center justify-between overflow-hidden xl:visible xl:flex xl:h-auto xl:w-10/12 ${
							navbarOpen
